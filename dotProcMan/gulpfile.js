/// <binding BeforeBuild='compile:scss, min' Clean='clean' ProjectOpened='watch:scss' />
"use strict";
...
paths.jsLibs = [paths.libs + "jquery/dist/jquery.js", paths.libs + "bootstrap/dist/js/bootstrap.js"];
...
gulp.task("min:js", function () {
    return gulp.src([paths.js, "!" + paths.concatJsDest, "!" + paths.concatJsLibsDest])
...
gulp.task("min:css", function () {
    return gulp.src([paths.css + "*.css", "!" + paths.concatCssDest, "!" + paths.concatCssLibsDest])
